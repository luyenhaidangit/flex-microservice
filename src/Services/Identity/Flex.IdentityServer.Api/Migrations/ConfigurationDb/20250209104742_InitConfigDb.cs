        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DPoPValidationMode = table.Column<int>(type: "NUMBER(10)", nullable: false),
                    DPoPClockSkew = table.Column<TimeSpan>(type: "INTERVAL DAY(8) TO SECOND(7)", nullable: false),
                    ...
                    InitiateLoginUri = table.Column<string>(type: "NVARCHAR2(2000)", maxLength: 2000, nullable: true),
                    ...
                    CibaLifetime = table.Column<int>(type: "NUMBER(10)", nullable: true),
                    PollingInterval = table.Column<int>(type: "NUMBER(10)", nullable: true),
                    CoordinateLifetimeWithUserSession = table.Column<bool>(type: "BOOLEAN", nullable: true),
                    Created = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    Updated = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    LastAccessed = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
                    NonEditable = table.Column<bool>(type: "BOOLEAN", nullable: false),
                    PushedAuthorizationLifetime = table.Column<int>(type: "NUMBER(10)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    Scheme = table.Column<string>(type: "NVARCHAR2(200)", maxLength: 200, nullable: false),
                    DisplayName = table.Column<string>(type: "NVARCHAR2(200)", maxLength: 200, nullable: true),
                    Enabled = table.Column<bool>(type: "BOOLEAN", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    PostLogoutRedirectUri = table.Column<string>(type: "NVARCHAR2(400)", maxLength: 400, nullable: false),
                    ClientId = table.Column<int>(type: "NUMBER(10)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    RedirectUri = table.Column<string>(type: "NVARCHAR2(400)", maxLength: 400, nullable: false),
                    ClientId = table.Column<int>(type: "NUMBER(10)", nullable: false)
                },
                constraints: table =>
                {
