        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Key = table.Column<string>(type: "NVARCHAR2(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "NUMBER(19)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    ReferenceValueHash = table.Column<string>(type: "NVARCHAR2(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Scheme = table.Column<string>(type: "NVARCHAR2(100)", maxLength: 100, nullable: false),
                    SubjectId = table.Column<string>(type: "NVARCHAR2(100)", maxLength: 100, nullable: false),
                    SessionId = table.Column<string>(type: "NVARCHAR2(100)", maxLength: 100, nullable: true),
                    DisplayName = table.Column<string>(type: "NVARCHAR2(100)", maxLength: 100, nullable: true),
                    Created = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    Renewed = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: false),
                    Expires = table.Column<DateTime>(type: "TIMESTAMP(7)", nullable: true),
